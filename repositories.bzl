...
def go_repositories():
    ...
    go_repository(
        name = "com_github_dgraph_io_dgo",
        importpath = "github.com/dgraph-io/dgo",
        sum = "h1:W9JVVHVto8SICJt9vkWcofcJRi2gxJRRj0Qzu3Q43nY=",
        version = "v0.0.0-20190801004348-3d281925f1d3",
    )
    go_repository(
